...
'(3 4 (5 crossroads . foothill))
; expect (3 4 (5 crossroads . foothill))
...
(define y (* 2 (begin (square 3) (triple 7) (+ 8 9))))
; expect y
...
(let ((a 10) (b (* a b))) (cons a (cons b nil)))
; expect (10 10)

(define f (mu (u) (* u v)))
; expect f

(define g (lambda (u v) (f (* v v))))
; expect g
